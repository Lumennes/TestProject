...
namespace StarterAssets
{
  ...
  public class FirstPersonController : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      // в общем тут показываем экранные джойстики если игра запущена на Android или в Simulator реадктора Unity
      {
        bool isMobile = false;
        ...
        if (_joysticks)
        {
          ...
          isMobile = UnityEngine.Device.SystemInfo.deviceType != DeviceType.Desktop; // мобайл если включен режим симулятора
					...
					if(Application.platform == RuntimePlatform.WebGLPlayer) // если WebGL, то мобайл если на мобильном запущн
					{
